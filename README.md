...
- [NO no Account is not just a database , whose history is traced and logged .](https://dev.to/niranjannlc/no-no-account-is-not-just-a-database-whose-history-is-traced-and-logged--2092)
